...
public class Pin extends JFrame implements ActionListener {
    ...
    Pin() {
        ...
        l1.setBounds(170, 130, 800, 60);
        add(l1);

        l2.setBounds(50, 240, 150, 40);
        add(l2);

        l3.setBounds(50, 300, 150, 40);
        add(l3);

        l4.setBounds(50, 360, 200, 40);
        add(l4);

        t1.setBounds(260, 240, 360, 40);
        add(t1);

        t2.setBounds(260, 300, 360, 40);
        add(t2);

        t3.setBounds(260, 360, 360, 40);
        add(t3);

        b1.setBounds(170, 460, 160, 50);
        add(b1);

        b2.setBounds(350, 460, 160, 50);
        add(b2);
