...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        l10.setBounds(100,260,200,30);
        add(l10);
        
        c1.setBounds(100,300,200,30);
        add(c1);
        
        c2.setBounds(350,300,200,30);
        add(c2);
        
        c3.setBounds(100,340,200,30);
        add(c3);
        
        c4.setBounds(350,340,200,30);
        add(c4);
        
        c5.setBounds(100,370,200,30);
        add(c5);
        
        c6.setBounds(350,370,200,30);
        add(c6);
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    conn c1 = new conn();
                    String q1 = "insert into signup3 values('"+a+"','"+first8+"','"+first4+"','"+b+"')";  
                    String q2 = "insert into login values('"+first8+"','"+first4+"')";
                    String q3 ="insert into bank values(' "+first4+" ',null)";
